...
function Clock() {
	 ...
	 const start = () => {
			const id: number = Number(setInterval(() => {
				 setDate(new Date())
			}, 1000))
			setTimerId(id)
	 ...
	 const stringDate = date.toLocaleDateString('en-En') || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
